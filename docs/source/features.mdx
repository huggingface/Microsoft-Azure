...
1. Extensive Model Catalog Integration
    ...
    Over 10,000 Hugging Face models—including text, vision, speech, and multimodal models are directly accessible within Azure AI Foundry and Azure Machine Learning Studio for one-click deployment.
...
4. Enterprise-Grade Infrastructure and Developer Tools
    ...
    Integration with Azure Machine Learning SDK and Python APIs for seamless automation and scripting.
...
6. Community and Open-Source Ecosystem
    ...
    The Hugging Face models are powered by open-source inference engines backed by Transformers, Diffusers, or Sentence Transformers; as well as efficient production-ready solutions such as Text Generation Inference (TGI) or Text Embeddings Inference (TEI), among others.
