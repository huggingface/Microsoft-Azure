...
1. Extensive Model Catalog Integration
    ...
    Over 10,000 Hugging Face models—including text, vision, speech, and multimodal models are directly accessible within Microsoft Foundry Hub and Azure Machine Learning Studio for one-click deployment.
