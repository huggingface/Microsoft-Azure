...
<video src="https://huggingface.co/datasets/hf-azure-internal/documentation-image/resolve/main/managed-compute/hf-open-source-models-to-production-on-microsoft-foundry.mp4" controls muted loop preload="metadata" />
