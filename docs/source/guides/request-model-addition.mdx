...
At the moment the Hugging Face collection on Azure ML / AI contains +10,000 open models from the Hugging Face Hub, leveraging open-source inference solutions such as Text Generation Inference (TGI), Text Embeddings Inference (TEI), or the Hugging Face Inference Toolkit, among others to come.
