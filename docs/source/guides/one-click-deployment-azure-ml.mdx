...
<video src="https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/microsoft-azure/one-click-deployment-azure-ml.mp4" controls autoplay muted loop />
