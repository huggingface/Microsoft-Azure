...
Later, at Microsoft Ignite 2025, Azure AI Foundry was renamed to Microsoft Foundry, along with the announcement of a new experience, for a unified Azure platform-as-a-service offering for enterprise AI operations, model builders, and application development.
