...
More information about those GPU Types / Families can be found in the [Microsoft Azure Documentation - 'NC' sub-family GPU accelerated VM size series](https://learn.microsoft.com/en-us/azure/virtual-machines/sizes/gpu-accelerated/nc-family).
