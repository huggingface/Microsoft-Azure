...
Connect the deployment to a compatible harness, such as [Hermes Agent](../../harness/integrations/hermes-agent). Confirm that the harness supports Chat Completions and the model's reasoning controls.
